import { pgTable, serial, text, boolean, integer, timestamp, varchar, numeric, uniqueIndex, jsonb, foreignKey, index, primaryKey, pgSequence, pgEnum } from "drizzle-orm/pg-core"
