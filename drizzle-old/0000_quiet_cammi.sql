...
--> statement-breakpoint
ALTER TABLE "Passkey" ADD CONSTRAINT "Passkey_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "Passkey_userId_key" ON "Passkey" USING btree ("userId" text_ops);--> statement-breakpoint
...
CREATE INDEX "_PropertyToUtility_B_index" ON "_PropertyToUtility" USING btree ("B" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "Service_title_key" ON "Service" USING btree ("title" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "SubService_service_key" ON "SubService" USING btree ("service" text_ops);